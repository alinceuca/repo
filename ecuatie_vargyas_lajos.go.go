...
<html>
 <head>
  ...
  <title>Ecuatia de gradul 2</title>
 </head>
 <body>
  <h1><center>Ecuatia de gradul 2</center></h1></br>
  <center><div  style="border:1px solid red; width: 200px"><p>a<i>x</i><sup>2</sup> + b<i>x</i> + c = 0 </p>

  <form action="/" method="POST">
   <label for="a">a = </label><input type="text" name="a" size="2"> </br>
   <label for="b">b = </label><input type="text" name="b" size="2"> </br>
   <label for="c">c = </label><input type="text" name="c" size="2"> </br><p>&nbsp;</p>
