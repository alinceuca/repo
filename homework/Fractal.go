...
func main() {
	...
	//HLine(int(x1), 20, int(x2))
	//col = color.RGBA{0, 255, 0, 255} // Green
	//Rect(int(x1), int(y1), int(x2), int(y2))
	fulg(x1,y1,x2,y2,n,true);
...
func koch(x1,y1,x2,y2 float64, n int, test bool) {
	...
	//if n>0{
		...
		seg = math.Sqrt(math.Pow(x2-x1, 2) + math.Pow(y2-y1, 2))
		L := seg / 3
...
func fulg(x1,y1,x2,y2 float64, n int, test bool) {
