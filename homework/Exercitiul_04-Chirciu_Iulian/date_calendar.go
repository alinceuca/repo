...
func main() {
	...
	for true {
		fmt.Println("Welcome!")
		fmt.Println("1. Diferenta dintre date")
		fmt.Println("2. Adauga o data + numarul de zile")
		fmt.Println("3. Adauga o data - numarul de zile")
		fmt.Println("4. Ziua saptamanii din data selectata")
		fmt.Println("5. Exit")
