...
func main() {
	...
	equation := Equation{}
	templates := template.Must(template.ParseFiles("C:\Users\IulianChirciu\Desktop\Chirciu Iulian\repo\homework\Exercitiul_05-Chirciu_Iulian\indexHtml\index.html"))
